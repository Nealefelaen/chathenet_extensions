...
(function() {
    ...
    var smileyArray = [
        ...
        [":O", 'https://i106.photobucket.com/albums/m271/pixel_and_bean/animated%20gifs/ohmy.gif'],
        [":-O", 'http://e.deviantart.net/emoticons/e/eek.gif'],
        [":wave:", 'https://i.imgur.com/OR5qCzd.gif'],
        [":sadpanda:", 'http://digital-impulse.com/wp-content/plugins/smilies-themer/digicons/SadPanda.png'],
        ...
        [":faith:", 'https://static.chathe.net/img_proxy.php?u=http://yoursmiles.org/msmile/compgame/m0314.gif'],
    ...
    ob.observe(document.getElementsByClassName("messages")[0], {attributes: true, childList: true, characterData: true});
